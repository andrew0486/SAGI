	...
	Vanadium
			.addValidatorTypes( [
					...
					[
							...
							"<small>&nbsp&nbsp&nbsp Numero invalido (intente sin espacios)." ],
					[
							"float",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
					...
					[
							...
							"<small>&nbsp&nbsp&nbsp Direccion de correo invalida, alguien@ejemplo.com</small>" ],
					[
							"url",
							function(a) {
								return Vanadium.validators_types.empty.test(a)
					...
					[
							...
							function(b, c) {
								var a = document.getElementById(c);
								if (a) {
									return '<small>&nbsp&nbsp&nbsp Este valor no coincide con <span class="'
											+ Vanadium.config.message_value_class
											+ '">'
											+ 'Contrasena'
											+ "</span>."
